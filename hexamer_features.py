...
Result_dir = 'Results/feature_extraction_results'
# Define default options.
def fileoutput(fasta,num):
    ...
    output_filename = "Results/feature_extraction_results/features.csv"
    ...
    sys.stdout.write("Consider %d kmers.\n" % len(kmer_list))
    ...
    while (id != ""):
      ...
      if (i_sequence % 1000 == 0):
        sys.stdout.write("Reading %dth sequence.\n" % i_sequence)
